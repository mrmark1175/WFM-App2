import{j as s,r as p}from"./index-D0d-jcTp.js";import{P as m}from"./PageLayout-BdUngTN-.js";const g=`# Auto-Scheduler — User Guide
...
2. Pick the channel, staffing mode, month, and scheduling week you want to hand off.
3. Review the required-FTE preview and resolve any validation warnings.
4. Click **"Approve Demand Snapshot"**.
5. Toast confirms: *"Approved snapshot #N for scheduling (X intervals)"*.
...
- **Fixed rest days** (e.g., Sat+Sun accommodation) are honored when they still allow the configured workdays inside operating hours; conflicts are corrected and reported as warnings.
...
- **"No approved snapshots"** — Approve a demand snapshot in Intraday Forecast first.
